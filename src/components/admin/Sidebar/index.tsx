            ...
            <Sidebar.ItemGroup>
              <Sidebar.Item
                ...
                className={`cursor-pointer ${
                  '/admin' === currentPage ? 'bg-gray-300 dark:bg-gray-700' : ''
                }`}
              >
                Dashboard
              </Sidebar.Item>
              <Sidebar.Item
                ...
                icon={HiShoppingBag}
                className={`cursor-pointer ${
                  '/admin/products' === currentPage ? 'bg-gray-300 dark:bg-gray-700' : ''
                }`}
              >
                Products
              </Sidebar.Item>
              ...
              <Sidebar.Item
                ...
                icon={HiUsers}
                className={`cursor-pointer ${
                  '/admin/users' === currentPage ? 'bg-gray-300 dark:bg-gray-700' : ''
                }`}
              >
                Users list
              </Sidebar.Item>
              <Sidebar.Item
                ...
                className={`cursor-pointer ${
                  '/admin/orders' === currentPage ? 'bg-gray-300 dark:bg-gray-700' : ''
                }`}
              >
                Orders
              </Sidebar.Item>
              <Sidebar.Item
                ...
                icon={HiCollection}
                className={`cursor-pointer ${
                  '/admin/toppings' === currentPage ? 'bg-gray-300 dark:bg-gray-700' : ''
                }`}
              >
                Toppings
              </Sidebar.Item>
