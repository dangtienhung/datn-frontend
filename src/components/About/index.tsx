...
const About = (props: Props) => {
  return (
    <div>
      <div className="container mx-auto relative flex justify-end items-center">
        <img className="w-full" src="/banner_about_us.png" alt="" />
        <div className="content flex flex-col items-center z-[2] w-[35%] absolute mr-10">
          <div className="title flex flex-col items-center">
            <h4 className="sub_title text-[#d3b673]  text-[22px] mb-[5px] font-bold">
              ToCoToCo Story
            </h4>
            <h3 className="main_title text-4xl  text-black uppercase font-bold px-[50px] mb-2">
              Về chúng tôi
            </h3>
          ...
          <div className="hover:bg-white hover:text-[#d3b673]">
      ...
      <div className="container mx-auto mt-5 mb-[60px] border-[6px] border-[#d3b673] flex">
        <div className="w-[50%] flex flex-col items-center justify-center mx-[10%]">
          <div className="title flex flex-col items-center">
            ...
            <h3 className="font-bold uppercase text-4xl text-black mb-2">Nhượng quyền</h3>
            <div className="bg_title"></div>
          </div>
