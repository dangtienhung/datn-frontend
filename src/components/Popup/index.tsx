...
const Popup = (props: Props) => {
  ...
  return isShowPopup ? (
    <div>
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-auto h-auto z-10">
        <div className="btn-close absolute -right-[30px] -top-[30px] ">
          <button
            onClick={handleClick}
            className="rounded-[50%] py-[5px] px-[10px]  z-[6] w-[30px] h-[30px] bg-white flex items-center justify-center hover:scale-[1.1]"
          >
            <FaTimes />
          </button>
        </div>
